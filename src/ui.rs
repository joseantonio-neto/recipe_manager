...
impl Sandbox for RecipeManagerGUI {
    ...
    fn update(&mut self, message: Message) {
        match message {
            ...
            Message::LoadRecipes => match self.recipe_manager.load_from_file("recipes.json") {
    ...
    fn view(&self) -> Element<Message> {
            ...
            .fold(Column::new().spacing(10), |column, recipe| {
                column.push(
                    Row::new()
                        ...
                        .push(
                            Button::new(Text::new("Edit")).on_press(Message::EditRecipe(recipe.id)),
                        )
                        .push(
        ...
        let recipes_list = Scrollable::new(recipes).height(Length::Fill);
